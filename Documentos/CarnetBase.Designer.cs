namespace DSOO_PI1_ComB_Grupo15_Paez_Fernandez.Documentos
{
    partial class CarnetBase
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CarnetBase));
            pnlDatos = new Panel();
            ...
            pnlDatos.Controls.Add(txtNro);
            pnlDatos.Controls.Add(picLogo);
            pnlDatos.Controls.Add(lblNro);
            pnlDatos.Location = new Point(199, 145);
            ...
            // txtNro
            // 
            txtNro.BackColor = Color.FromArgb(128, 255, 128);
            txtNro.BorderStyle = BorderStyle.None;
            txtNro.ForeColor = SystemColors.ActiveCaptionText;
            txtNro.Location = new Point(124, 13);
            txtNro.Name = "txtNro";
            txtNro.Size = new Size(186, 16);
            txtNro.TabIndex = 2;
            // 
            // picLogo
            // 
            ...
            lblNro.Font = new Font("Microsoft Sans Serif", 8.25F, FontStyle.Regular, GraphicsUnit.Point);
            lblNro.Location = new Point(52, 14);
            lblNro.Name = "lblNro";
            lblNro.Size = new Size(76, 13);
            lblNro.TabIndex = 0;
            lblNro.Text = "NÚMERO DE ";
            // 
            // btnImprimir
            // 
            btnImprimir.Location = new Point(451, 340);
            ...
            pnlTitulo.Location = new Point(199, 85);
        ...
        protected Label lblFechaAlta;
        protected Label lblNombre;
        protected TextBox txtNro;
        protected PictureBox picLogo;
        protected Label lblNro;
